...
@Component({
    ...
    , templateUrl: './expense.approvalHistory.template.html',
   // , directives: [BasicGrid, BasicCellC, UiInput, StatusStep, UiForm, UiFormControl, MaterializeDirective, RestrictValueTo, LoaderComponent],
    ...
    `],
  //  pipes: [LocationPipe, CurrencyPipe, ApprovalStatus, ApprovalStatusTitle, CurrencyCommaPipe, CurrencyNamePipe]
})
