...
@NgModule({
  ...
  declarations: [TravelComponent, TravelNewComponent, TravelHistory, TravelNewRequestComponent, TravelApprovalHistory, ViewMyHistoryComponent, TravelApprovalHistoryView, TravelViewRequestComponent],
