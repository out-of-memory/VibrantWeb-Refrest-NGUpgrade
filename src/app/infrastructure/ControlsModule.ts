...
import { ModulePipe , TicketStatusPipe, ApprovalStatus,ApprovalStatusTitle,CurrencyPipe, OptionTextPipe,LocationPipe,CurrencyCommaPipe, CurrencyNamePipe} from './Pipes/Pipes';
@NgModule({
  imports:      [ CommonModule,FormsModule,ReactiveFormsModule ,ChartsModule],
  declarations: [ MaterializeDirective, UpdateMaterializeParams, RestrictValueTo ,Card,OptionTextPipe ,ModulePipe,TicketStatusPipe,ApprovalStatus,ApprovalStatusTitle,DoughnutChart,LineChart,LoaderComponent,UiFormControl,UiInput,UiCustomModal,UiForm,BasicCellC,BasicGrid,LocationPipe,CurrencyCommaPipe,StatusStep,CurrencyNamePipe,CurrencyPipe],
  exports:      [MaterializeDirective,ChartsModule, Card,CommonModule, FormsModule,ModulePipe,OptionTextPipe ,TicketStatusPipe,ApprovalStatus,ApprovalStatusTitle,DoughnutChart,LineChart,UiFormControl,UiForm,UiInput,UiCustomModal,BasicCellC,BasicGrid,LoaderComponent,LocationPipe,CurrencyCommaPipe,StatusStep,CurrencyNamePipe,CurrencyPipe]
})
