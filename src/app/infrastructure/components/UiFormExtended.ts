...
import { FormBuilder, Validators, ControlGroup, AbstractControl} from '@angular/Forms';
...
@Component({
    ...
    <div [class]='formCss'>
        ...
        <form [ngFormModel]="mainForm" (submit)="doLogin($event)" class="form-element">
            ...
            <div *ngFor="let meta of controlMetas">
                
                <div *ngFor="let i of orientationArray" class='row'> 
                ...
                <ui-form-message 
                    [hidden]='formReadonly'
                    [message]='model[meta.name]' 
                    [error] ='dataModelControl[meta.name+"Control"]._errors' 
                    errorCss='error' 
                    successCss='success'>
                </ui-form-message>                            
                </div>
...
export class UiFormExtended implements OnInit {
////readonlyControls[meta.name]?readonlyControls[meta.name]:false
    ...
    private orientationArray:Array<number>;
    constructor(private fb: FormBuilder) {
        this.orientationArray=new Array<number>();
    }
    ngOnInit() {
                   for(var i=0;i<this.columnOrientation;i++) this.orientationArray.push[i];
